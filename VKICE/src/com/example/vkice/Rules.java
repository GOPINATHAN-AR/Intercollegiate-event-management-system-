...
public class Rules extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		IP = sp.getString("ip", "");
		web_url ="http://"+IP+"/PhpAndr_ICE/getrules.php";
		new GetRulesTask(this).execute(web_url);
	}
...
class GetRulesTask extends AsyncTask<String, Void, String> {

	private Rules activity;
	ProgressDialog pdialog;
	HttpEntity entity=null;
	
	public GetRulesTask(Rules activity) {
