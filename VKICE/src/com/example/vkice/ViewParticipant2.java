...
public class ViewParticipant2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.viewparticipant2);
		...
		IP = sp.getString("ip", "");
		Intent i1 = getIntent();
		dept = i1.getStringExtra("dept");
		web_url ="http://"+IP+"/PhpAndr_ICE/viewparticipant.php";
		new FetchParticipantTask(this).execute(web_url,sn.getString("userid", ""),dept);
	}
...
class FetchParticipantTask extends AsyncTask<String, Void, String> {

	private ViewParticipant2 activity;
	ProgressDialog pdialog;
	HttpEntity entity=null;
	
	public FetchParticipantTask(ViewParticipant2 activity) {
