...
public class ViewPrelims extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.viewprelims);
		...
		new FetchPrelimsTask(this).execute(web_url,sn.getString("userid", ""));
	}
...
class FetchPrelimsTask extends AsyncTask<String, Void, String> {

	private ViewPrelims activity;
	ProgressDialog pdialog;
	HttpEntity entity=null;
	
	public FetchPrelimsTask(ViewPrelims activity) {
