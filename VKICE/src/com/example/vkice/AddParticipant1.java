...
public class AddParticipant1 extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.addparticipant1);
		...
		IP = sp.getString("ip", "");
		web_url ="http://"+IP+"/PhpAndr_ICE/addparticipant.php";		
		b1.setOnClickListener(this);
	}

	@Override
	public void onClick(View v) {
		Intent i1 = new Intent(this, AddParticipant2.class);
